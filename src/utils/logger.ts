...
export class Logger {
  ...
  private static minLevel: LogLevel = LogLevel.WARN; // Only show warnings and errors by default
  ...
  public static async initialize(): Promise<void> {
    ...
    Logger.minLevel = settings.debugMode ? LogLevel.DEBUG : LogLevel.WARN; // Show all logs in debug mode, only warnings/errors otherwise
  }
  ...
  public static setDebugMode(enabled: boolean): void {
    ...
    Logger.minLevel = enabled ? LogLevel.DEBUG : LogLevel.WARN;
  }
